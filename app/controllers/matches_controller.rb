...
class MatchesController < AdminController
  ...
  def index # rubocop:todo Metrics/PerceivedComplexity, Metrics/CyclomaticComplexity
  ...
  def update # rubocop:todo Metrics/PerceivedComplexity, Metrics/CyclomaticComplexity
    save_and_continue = params[:commit]&.downcase&.include?('save and view match')
  ...
  def set_form_dropdowns # rubocop:todo Metrics/PerceivedComplexity, Metrics/CyclomaticComplexity
